...
TEST_F(BatAdsNextPaymentDateUtilTest,
       BeforeNextPaymentDayWithPendingBalanceLastMonth) {
  // Arrange
...
TEST_F(BatAdsNextPaymentDateUtilTest,
       BeforeNextPaymentDayWithNoPendingBalanceLastMonth) {
  // Arrange
  base::FieldTrialParams parameters;
  parameters["next_payment_day"] = "5";
...
TEST_F(BatAdsNextPaymentDateUtilTest,
       AfterNextPaymentDayWithPendingBalanceThisMonth) {
  // Arrange
  base::FieldTrialParams parameters;
  parameters["next_payment_day"] = "5";
...
TEST_F(
    ...
    AfterNextPaymentDayWhenNextTokenRedemptionDateIsThisMonthAndNoPendingBalanceThisMonth) {  // NOLINT
  // Arrange
  base::FieldTrialParams parameters;
  parameters["next_payment_day"] = "5";
...
TEST_F(
    BatAdsNextPaymentDateUtilTest,
    AfterNextPaymentDayWhenNextTokenRedemptionDateIsNextMonthAndNoPendingBalanceThisMonth) {  // NOLINT
  // Arrange
  base::FieldTrialParams parameters;
  parameters["next_payment_day"] = "5";
